...
public class VuforiaThread extends Thread {
    ...
    private void instantiateVuforia(HardwareMap hardwareMap){
        /*
        ...
        final float CAMERA_LEFT_DISPLACEMENT     = -160.0f;     // eg: Camera is ON the robot's center line
    ...
    //Constructor
    public VuforiaThread(HardwareMap hardwareMap) {
        instantiateVuforia(hardwareMap);
